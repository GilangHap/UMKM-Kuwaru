...
export default function Show({ umkm, products = [], articles = [] }: Props) {
            ...
            <PublicLayout title="Memuat...">
                <div className="min-h-screen flex items-center justify-center bg-slate-900">
                    <div className="text-center">
                        ...
                        <p className="text-slate-400">Memuat data UMKM...</p>
                    </div>
                </div>
            </PublicLayout>
        );
    ...
    const primaryColor = umkm.theme?.primary_color || '#10b981';
    const secondaryColor = umkm.theme?.secondary_color || '#06b6d4';
    ...
    return (
        ...
        >
            ...
            <section className="relative min-h-[70vh] md:min-h-[80vh] overflow-hidden flex items-center">
                ...
                {umkm.gallery_thumbnail && (
                    <img 
                        ...
                        alt={`${umkm.name} background`}
                        className="absolute inset-0 w-full h-full object-cover"
                    />
                )}
                
                {/* Animated Background Overlay with UMKM Theme Colors */}
                <div 
                    className="absolute inset-0"
                    style={{ 
                        background: umkm.gallery_thumbnail 
                            ? `linear-gradient(135deg, rgba(15,23,42,0.9) 0%, ${primaryColor}40 30%, ${secondaryColor}40 70%, rgba(15,23,42,0.95) 100%)`
                            : `linear-gradient(135deg, #0f172a 0%, ${primaryColor}20 30%, ${secondaryColor}20 70%, #0f172a 100%)`
                    }}
                />
                ...
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    ...
                    />
                    <div 
                        className="absolute -bottom-1/4 -left-1/4 w-[500px] h-[500px] rounded-full opacity-20 blur-3xl animate-pulse" 
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                    <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
                        ...
                        <div className="relative group">
                            ...
                            {umkm.logo_url ? (
                                <img 
                                    src={umkm.logo_url} 
                                    alt={umkm.name}
                                    className="relative w-36 h-36 md:w-48 md:h-48 rounded-3xl object-cover border-4 border-white/30 shadow-2xl transform group-hover:scale-105 transition-transform duration-300"
                                />
                            ) : (
                                <div 
                                    className="relative w-36 h-36 md:w-48 md:h-48 rounded-3xl flex items-center justify-center text-6xl md:text-7xl font-bold text-white border-4 border-white/30"
                        ...
                        <div className="text-center lg:text-left flex-1">
                            {/* Category Badge */}
                            <div 
                                className="inline-flex items-center gap-2 px-4 py-2 rounded-full backdrop-blur-sm text-sm font-medium mb-6"
                                style={{ backgroundColor: `${primaryColor}30`, color: primaryColor, border: `1px solid ${primaryColor}50` }}
                            >
                            ...
                            <div className="flex flex-wrap justify-center lg:justify-start gap-6 mb-8">
                                ...
                                {featuredProducts.length > 0 && (
                                    <div className="text-center px-4 py-2 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10">
                                        <div className="text-3xl font-bold" style={{ color: accentColor }}>{featuredProducts.length}</div>
                                        <div className="text-sm text-slate-400">Unggulan</div>
                                    </div>
                                )}
                            </div>
                            ...
                            <div className="flex flex-wrap justify-center lg:justify-start gap-4">
                                {umkm.whatsapp && (
                                    <a
                                        ...
                                        className="inline-flex items-center gap-2 px-6 py-3 bg-green-500 text-white font-semibold rounded-xl hover:bg-green-600 transition-all duration-200 shadow-lg shadow-green-500/25 hover:shadow-xl hover:shadow-green-500/30 transform hover:-translate-y-0.5"
                                    >
                                ...
                                <button
                                    ...
                                    className="inline-flex items-center gap-2 px-6 py-3 bg-white/10 backdrop-blur-sm text-white font-semibold rounded-xl hover:bg-white/20 transition-all duration-200 border border-white/20"
                                >
                            ...
                            {/* Share Menu Popup */}
                            {showShareMenu && (
                                <div className="mt-4 p-4 bg-white/10 backdrop-blur-sm rounded-xl inline-flex gap-3 border border-white/20 animate-fade-in">
                                    <a
                    ...
                    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-slate-400 max-w-2xl mx-auto">
                                Lihat lebih dekat produk dan aktivitas {umkm.name}
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                            {umkm.gallery.map((item, index) => (
                                <button
                                    ...
                                    className="group relative aspect-square rounded-2xl overflow-hidden focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:ring-offset-slate-900"
                                >
                                    <img 
                                        src={item.url} 
                                        alt={item.alt_text || `${umkm.name} gallery ${index + 1}`}
            ...
            {/* Lightbox Modal */}
            {lightboxOpen && umkm.gallery && umkm.gallery.length > 0 && (
                <div 
                ...
                >
                    ...
                    {umkm.gallery.length > 1 && (
                        <button
                            onClick={(e) => {
                                e.stopPropagation();
                                setLightboxIndex((prev) => (prev === 0 ? umkm.gallery!.length - 1 : prev - 1));
                            }}
                    ...
                    {umkm.gallery.length > 1 && (
                        <button
                            onClick={(e) => {
                                e.stopPropagation();
                                setLightboxIndex((prev) => (prev === umkm.gallery!.length - 1 ? 0 : prev + 1));
                            }}
                    ...
                    {/* Image */}
                    <img 
                        src={umkm.gallery[lightboxIndex].url} 
                        alt={umkm.gallery[lightboxIndex].alt_text || `${umkm.name} gallery`}
                    ...
                    <div className="absolute bottom-4 left-1/2 -translate-x-1/2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm text-white text-sm">
                        {lightboxIndex + 1} / {umkm.gallery.length}
                    </div>
                </div>
            )}
                    ...
                    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                            {featuredProducts.map((product) => (
                                <div 
                                    key={product.id}
                                    className="group relative rounded-3xl overflow-hidden bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-md border border-white/10 hover:border-white/30 transition-all duration-500 hover:scale-[1.02] hover:-translate-y-2 hover:shadow-2xl"
                                >
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
                            {regularProducts.map((product) => (
                                <div 
                                    key={product.id}
                                    className="group rounded-2xl overflow-hidden bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-md border border-white/10 hover:border-white/30 transition-all duration-300 hover:scale-[1.02]"
                                >
                                    <div className="relative aspect-square overflow-hidden">
                                        {product.thumbnail ? (
                                            <img 
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {articles.map((article) => (
                                <Link
                                    ...
                                    className="group rounded-3xl overflow-hidden bg-gradient-to-b from-white/10 to-white/5 backdrop-blur-md border border-white/10 hover:border-white/30 transition-all duration-500 hover:scale-[1.02] hover:-translate-y-2"
                                >
                                    ...
                                    <div className="p-5">
                                        <h3 className="font-bold text-white mb-2 line-clamp-2 group-hover:text-emerald-400 transition-colors">
                                            {article.title}
                                        </h3>
                                        {article.excerpt && (
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            {umkm.whatsapp && (
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="flex items-center gap-4 p-5 bg-gradient-to-r from-green-500/20 to-green-600/20 rounded-2xl hover:from-green-500/30 hover:to-green-600/30 transition-all border border-green-500/30"
                                >
                                    <div className="w-14 h-14 rounded-xl bg-green-500 flex items-center justify-center shadow-lg shadow-green-500/25">
                                        <svg className="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/>
                                        </svg>
                                    </div>
                                    <div className="flex-1">
                                        <p className="text-sm text-green-400">WhatsApp</p>
                                        <p className="font-bold text-lg text-white">{umkm.whatsapp}</p>
                                    </div>
                            ...
                            {umkm.phone && (
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="font-bold text-lg text-white">{umkm.phone}</p>
                                    </div>
                                </a>
                            )}
                            ...
                            {umkm.email && (
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="font-bold text-lg text-white">{umkm.email}</p>
                                    </div>
                                </a>
                            )}

                            {umkm.address && (
                                <div className="flex items-start gap-4 p-5 rounded-2xl border border-white/10 bg-white/5">
                                    <div className="w-14 h-14 rounded-xl bg-purple-500/30 flex items-center justify-center shrink-0">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-medium text-white">{umkm.address}</p>
                                    </div>
                                </div>
                            )}
                        </div>
                        ...
                        {umkm.latitude && umkm.longitude && (
                            <div className="rounded-3xl overflow-hidden border border-white/10 h-80 lg:h-auto lg:min-h-[400px]">
                                <iframe
