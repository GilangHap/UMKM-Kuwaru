...
export default function Gallery({ umkm }: Props) {
    ...
    const handleUpload = (files: FileList) => {
        ...
        router.post(route('umkm.gallery.upload'), formData, {
            forceFormData: true,
            onFinish: () => {
                setUploading(false);
    ...
    const handleDelete = (mediaId: string) => {
        if (confirm('Apakah Anda yakin ingin menghapus foto ini?')) {
            router.delete(route('umkm.gallery.delete', { media: mediaId }));
        }
    };
    ...
    const handleReorder = (dragIndex: number, dropIndex: number) => {
        ...
        router.put(route('umkm.gallery.reorder'), {
    ...
    return (
        ...
        >
            ...
            <div className="card p-6 mb-6">
                <h3 className="text-lg font-semibold text-foreground mb-2">Upload Foto</h3>
                <p className="text-sm text-muted mb-4">
                    Upload foto-foto untuk ditampilkan di halaman profil UMKM Anda.
                </p>
                <div
                    className={`
            ...
            <div className="card p-6">
                <h3 className="text-lg font-semibold text-foreground mb-4">
                    Foto Galeri ({umkm.gallery?.length || 0})
                </h3>
                ...
                {umkm.gallery && umkm.gallery.length > 0 ? (
                    ...
                    <div className="text-center py-12 text-muted">
                        ...
                        <p className="text-sm">Upload foto untuk menampilkan galeri UMKM Anda</p>
                    </div>
                )}
